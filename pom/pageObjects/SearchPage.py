class SearchPage:
    ...
    def __init__(self, page):
        ...
        self.number_input = page.locator('//*[@id="root"]/div/div[2]/div/div/div[2]/div/div[2]/div[2]/div/form/div/div[3]/div/div/select')
        self.cuntry_button = page.locator('//*[@id="root"]/div/div[2]/div/div/div[2]/div/div[2]/div[2]/div/form/div/div[3]/div/div/select/option[28]')
    ...
    def search(self, fullname, email, subject, number, message):
        ...
        self.search_term_input.press("SEND")
